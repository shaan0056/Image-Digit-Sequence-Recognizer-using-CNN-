...
if __name__ == "__main__":
        ...
        Checkpoint = tf.keras.callbacks.ModelCheckpoint("myDetectorCNN.h5", monitor='val_acc', mode='max', verbose=0,
        ...
        csv_logger = tf.keras.callbacks.CSVLogger('log_detector.csv', append=True, separator=';')
        ...
        best_model = tf.keras.models.load_model("myDetectorCNN.h5")
